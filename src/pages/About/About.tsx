                    ...
                    <Row className="text-center">
                        <Col>
                            <h1 className="display-3 fw-bold mb-4">
                                <i className="bi bi-people-fill me-3" style={{ color: 'var(--color-1)' }}></i>
                                Sobre Nosotros
                                <span className="d-block" style={{ color: 'var(--color-1)' }}>Steamish Gaming</span>
                            </h1>
            ...
            <section className="py-5">
                <Container>
                    <Row className="align-items-center g-5">
                        <Col lg={6}>
                            <h2 className="display-5 fw-bold mb-4" style={{ color: 'var(--color-4)' }}>
                        ...
                        <Col lg={6} className="text-center">
                            <Card className="shadow-lg border-0">
                                <Card.Body className="p-5">
                                    <div className="text-white rounded-3 p-4 mb-3" style={{ background: 'var(--gradient-primary)' }}>
                                        <i className="bi bi-lightbulb display-1"></i>
                                    </div>
                                    <Card.Title className="h3" style={{ color: 'var(--color-4)' }}>Innovación</Card.Title>
            ...
            <section className="py-5 bg-white">
                <Container>
                    <Row className="text-center mb-5">
                        <Col>
                            <h2 className="display-5 fw-bold" style={{ color: 'var(--color-4)' }}>
